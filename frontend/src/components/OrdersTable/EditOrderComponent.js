...
class EditOrder extends React.Component {
    constructor(props){
        ...
        let order = orders.find(x => x.id === this.props.orderId);
        this.state = {
            id: order.id,
            date: order.date,
            price:  order.price,
    ...
    saveNewOrder() {
        ...
        let orders = JSON.parse(localStorage.getItem('orders'));
        let orderIndex = orders.findIndex(order => order.id === this.state.id);
...
export default withStyles(editOrderStyles)(EditOrder)
